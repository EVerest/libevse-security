...
enum class CryptoKeyType {
    EC_prime256v1 = 0, // Default EC. P-256, ~equiv to rsa 3072
    EC_secp384r1 = 1,  // P-384, ~equiv to rsa 7680
    RSA_2048 = 2,
    RSA_TPM20 = RSA_2048, // Default TPM RSA, only option allowed for TPM (universal support), 2048 bits
    RSA_3072 = 3,         // Default RSA. Protection lifetime: ~2030
    RSA_7680 = 4,         // Protection lifetime: >2031. Very long generation time 8-40s on 16 core PC
};
